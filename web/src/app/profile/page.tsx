        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 lg:pb-8">
          ...
          <div className="lg:hidden mb-6">
            <select
              ...
              value=""
              className="w-full rounded-lg bg-white/5 border border-white/10 px-4 py-3 text-white focus:outline-none focus:border-[#FF5A75]/50"
            >
              <option value="" disabled>快速导航...</option>
              <option value="user">个人背景</option>
              <option value="content">内容偏好</option>
              <option value="publishing">发布设置</option>
            </select>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="sticky top-4 space-y-3">
                  <nav className="flex flex-col gap-2 p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                    {[
                      ...
                      >
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FF5A75]/20 to-[#FF2442]/20 flex items-center justify-center flex-shrink-0 group-hover:from-[#FF5A75]/30 group-hover:to-[#FF2442]/30 transition-all">
                          <item.icon className="w-5 h-5 text-[#FF5A75]" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-white group-hover:text-[#FF5A75] transition-colors">{item.label}</p>
                  ...
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                    ...
                    <Button
                      onClick={saveProfile}
                      disabled={saving}
                      className="w-full h-10 bg-gradient-to-r from-[#FF5A75] to-[#FF2442] hover:from-[#FF5A75]/90 hover:to-[#FF2442]/90 text-white shadow-lg shadow-[#FF2442]/20 text-sm"
                    >
                      {saving ? (
                        <>
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  <Card className="border-white/10 bg-white/5 backdrop-blur-sm">
                    <CardHeader className="pb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FF5A75]/20 to-[#FF2442]/20 flex items-center justify-center">
                          <User className="w-5 h-5 text-[#FF5A75]" />
                        </div>
                        <div>
                            ...
                            <button
                              ...
                              className={`p-2.5 rounded-lg border text-left transition-all ${
                                profile.user.preferences?.styles?.includes(s.value)
                                  ? 'bg-gradient-to-r from-[#FF5A75]/20 to-[#FF2442]/20 border-[#FF5A75]/50'
                ...
                <section id="content">
                  <Card className="border-white/10 bg-white/5 backdrop-blur-sm">
                    <CardHeader className="pb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FF5A75]/20 to-[#FF2442]/20 flex items-center justify-center">
                          <Tag className="w-5 h-5 text-[#FF5A75]" />
                        </div>
                        <div>
                ...
                <section id="publishing">
                  <Card className="border-white/10 bg-white/5 backdrop-blur-sm">
                    <CardHeader className="pb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FF5A75]/20 to-[#FF2442]/20 flex items-center justify-center">
                          <Bell className="w-5 h-5 text-[#FF5A75]" />
                        </div>
                        <div>
                      ...
                      <div className="space-y-3 p-3 rounded-lg bg-white/5 border border-white/10">
                        <div className="flex items-center justify-between">
                          ...
                          <input
                            ...
                            className="w-9 h-4.5 rounded-full appearance-none bg-white/10 checked:bg-gradient-to-r checked:from-[#FF5A75] checked:to-[#FF2442] cursor-pointer transition-all"
                          />
                        </div>
                ...
                {/* 移动端保存按钮 */}
                <div className="lg:hidden fixed bottom-4 left-0 right-0 p-4 bg-gradient-to-t from-[#0a0a0a] to-transparent">
                  <Button
                    onClick={saveProfile}
                    disabled={saving}
                    className="w-full h-12 bg-gradient-to-r from-[#FF5A75] to-[#FF2442] hover:from-[#FF5A75]/90 hover:to-[#FF2442]/90 text-white shadow-lg shadow-[#FF2442]/20"
                  >
                    {saving ? (
                      <>
